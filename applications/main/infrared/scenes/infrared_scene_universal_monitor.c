...
void infrared_scene_universal_monitor_on_enter(void* context) {
    ...
    button_panel_add_item(
        ...
        infrared_scene_universal_common_item_callback,
        context);
    button_panel_add_icon(button_panel, 36, 46, &I_rotate_text_24x5);
    ...
    button_panel_add_item(
        ...
        infrared_scene_universal_common_item_callback,
        context);
    button_panel_add_icon(button_panel, 6, 80, &I_mode_text_20x5);
    ...
    button_panel_add_item(
        ...
        infrared_scene_universal_common_item_callback,
        context);
    button_panel_add_icon(button_panel, 39, 80, &I_off_text_12x5);
