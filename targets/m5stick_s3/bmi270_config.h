...
/* Bosch BMI270 init config blob (BSD-3-Clause), extracted verbatim from the
 * BMI270-Sensor-API bmi270.c `bmi270_config_file[]`. 8192 bytes. */
static const uint8_t bmi270_config_file[BMI270_CONFIG_SIZE] = {
