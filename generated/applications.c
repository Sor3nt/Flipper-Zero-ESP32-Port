...
extern int32_t usb_storage_app(void* p);
...
const FlipperInternalApplication FLIPPER_SERVICES[] = {
    ...
    {.app = bt_srv, .name = "BtSrv", .appid = "bt", .stack_size = 8192, .icon = NULL, .flags = FlipperInternalApplicationFlagDefault},
...
const FlipperInternalApplication FLIPPER_APPS[] = {
    ...
    {.app = other_os_app, .name = "Bruce", .appid = "other_os", .stack_size = 4096, .icon = &A_Plugins_14, .flags = FlipperInternalApplicationFlagDefault},
    {.app = usb_storage_app, .name = "USB-Storage", .appid = "usb_storage", .stack_size = 4096, .icon = &A_Plugins_14, .flags = FlipperInternalApplicationFlagDefault},
};
